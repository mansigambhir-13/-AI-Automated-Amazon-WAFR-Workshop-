...
- [x] **AUTH-03**: Frontend provides login, signup, and password reset UI via Amplify
- [x] **AUTH-04**: Team users can create/view/manage all assessments; client users can only view their own
...
- [x] **SECR-04**: Audit trail logs who ran what assessment, when, with what transcript
...
| AUTH-03 | Phase 4 | Complete (04-01) |
